  ...
  return (
    <div key={item.id} className='relative flex flex-wrap w-full justify-between bg-red-20 even:bg-[rgba(185,170,170,0.25)] px-3 pt-2 pb-2 rounded-lg'>
        ...
        <div className='w-[25%] space-y-2'>
            <label htmlFor='code' className='text-sm font-medium md:text-lg'>Course<br/>Code</label>
        ...
        <div className='w-[15%] space-y-2'>
            <label htmlFor='unit' className='text-sm font-medium md:text-lg'>Course<br/>Unit</label>
        ...
        <div className='w-[20%] space-y-2'>
            <label htmlFor='grade' className='text-sm font-medium md:text-lg'>Marks<br/>Scored</label>
        ...
        <div className='w-[20%] mt-5'>
            <label htmlFor='aggregate' className='text-sm font-medium md:text-lg'>Grade</label>
