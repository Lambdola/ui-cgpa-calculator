...
function CgpaModal({cgpaState, setCgpaState}) {
  return (
    <div onClick={()=> setCgpaState({...cgpaState, state: false})}>
        ...
        <div className='absolute z-20  w-[80%] md:w-[55%] xl:w-[50%] left-[10%] md:left-[22%] xl:left-[25%] top-[25vh] h-[45vh] md:h-[40vh] rounded-lg bg-[rgba(24,23,54,0.8)] border p-3 md:p-10 xl:p-8 shadow-lg shadow-gray-400'>
